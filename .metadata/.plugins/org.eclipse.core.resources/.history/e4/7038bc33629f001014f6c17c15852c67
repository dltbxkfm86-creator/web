...
public class BoardService {
	...
	public List<com.kh.java.board.model.vo.Category> selectCategory() {
		
		SqlSession sqlSession = Template.getSqlSession();
		
		List<com.kh.java.board.model.vo.Category> categories = bd.selectCategory(sqlSession);
	...
	public int insert(Board board, Attachment at) {
		...
		// ATTACHEMTN 테이블에 한 번 => 파일이 존재할 때만 가야 함
		int atResult = 1;
		if(at != null) {
